 ...
 */
export function extractClassNames(value) {
 ...
 */
export function getClassValue(node) {
  // JSX: className="..."
 ...
 */
export function matchPatterns(classNames, patterns) {
  const matched = [];
 ...
 */
export function createMessage(classes, category, suggestion) {
